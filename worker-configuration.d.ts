/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./worker-configuration.d.ts` (hash: e2ebf74926fba00189d681341e6cfb41)
// Runtime types generated with workerd@1.20260625.1 2025-04-01 nodejs_compat
interface __BaseEnv_Env {
	...
	POLLER?: DurableObjectNamespace<import("./workers/app").PollerDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./workers/app");
		durableNamespaces: "PollerDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CHECK_POLL_INTERVAL_SECONDS" | "DATABASE_URL" | "DATABASE_AUTH_TOKEN" | "OFFICIAL_STATUS_CHECK_INTERVAL_SECONDS" | "CHECK_CONCURRENCY" | "HISTORY_RETENTION_DAYS">> {}
}
