...
type Module = typeof import("../dashboard.notifications_.$id.js")

type Info = GetInfo<{
  file: "routes/dashboard.notifications_.$id.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../dashboard.notifications_.$id.js");
}];
