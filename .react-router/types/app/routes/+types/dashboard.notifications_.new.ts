...
type Module = typeof import("../dashboard.notifications_.new.js")

type Info = GetInfo<{
  file: "routes/dashboard.notifications_.new.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../dashboard.notifications_.new.js");
}];
